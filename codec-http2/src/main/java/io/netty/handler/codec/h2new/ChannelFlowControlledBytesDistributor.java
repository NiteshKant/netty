...
public interface ChannelFlowControlledBytesDistributor {
    /**
     * Registers a {@link DistributionAcceptor} for the passed {@code streamId}. Only one {@link DistributionAcceptor}
     * per stream is allowed. In case, there already exists an {@link DistributionAcceptor} for this {@code streamId},
     * it will be {@link DistributionAcceptor#dispose() disposed} and the pending flow control credits will be
     * distributed to the new {@link DistributionAcceptor}.
     *
     ...
     */
    DistributionAcceptor replace(int streamId, DistributionAcceptor acceptor);
    ...
    interface DistributionAcceptor {
        ...
        /**
         * Disposes this acceptor which may happen due to stream closures or
         * {@link ChannelFlowControlledBytesDistributor#replace(int, DistributionAcceptor) replacement} of the acceptor.
         *
