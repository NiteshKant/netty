...
public class DefaultHttp2ClientSslContextBuilder implements Http2ClientSslContextBuilder {
    private final SslContextBuilder delegate;

    // TODO: Add other constructor variants.
    public DefaultHttp2ClientSslContextBuilder() {
    ...
    @Override
    public Http2ClientSslContext build() {
        return null;
    }
}
