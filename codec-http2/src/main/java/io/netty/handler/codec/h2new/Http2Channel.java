 ...
 * {@link ChannelHandler#write(ChannelHandlerContext, Object, ChannelPromise) writing} of {@link Http2Frame}s.
...
public interface Http2Channel extends Channel {
    ...
    void createStream(ChannelHandler handler, Promise<Http2StreamChannel> promise);
    // TODO: Add one override to use a bootstrap?
}
